...
def generate_random_address():
  ...
  street_names = ['Rue de la Loi', 'Avenue Louise', 'Place Sainte-Catherine', 'Boulevard Anspach', 'Chaussée de Waterloo', 'Avenue des Arts', 'Rue Royale', 'Rue Neuve', 'Rue Haute', 'Rue du Midi', 'Rue du Bailli', 'Avenue de Tervueren', 'Rue de l\'Ecuyer', 'Rue du Marché aux Herbes', 'Avenue Brugmann', 'Avenue Franklin Roosevelt', 'Avenue Adolphe Buyl', 'Rue Antoine Dansaert', 'Avenue de la Toison d\'Or', 'Rue Saint-Jacques', 'Rue de Flandre', 'Rue Antoine Dansaert', 'Rue Blaes', 'Rue du Page', 'Rue du Luxembourg']
  cities = ['Bruxelles', 'Liège', 'Charleroi', 'Namur', 'Mons', 'La Louvière', 'Tournai', 'Verviers', 'Mouscron', 'Courtrai']
  weights = [5, 2, 2, 1, 1, 1, 1, 1, 1, 1]
  zips = ['1000', '4000', '6000', '5000', '7000', '7100', '7500', '4800', '7700', '8500']
  state = ['BRU', 'WLG', 'WHT', 'NAM', 'HAI', 'WHT', 'HAI', 'LGE', 'HAI', 'WVH']
